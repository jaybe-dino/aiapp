...
const s = StyleSheet.create({
  ...
  soft: { flexDirection: "row", alignItems: "center", gap: 12, backgroundColor: T.brandSoft, borderRadius: 18, borderWidth: 1, borderColor: T.line, paddingVertical: 14, paddingHorizontal: 15, marginBottom: 12 },
  ...
  missionBar: { alignItems: "center", paddingVertical: 7, backgroundColor: T.brandSoft, borderTopWidth: 1, borderTopColor: T.line },
  missionBarText: { color: T.brandDark, fontWeight: "800", fontSize: 13 },
  missionDone: { backgroundColor: T.brandSoft, borderWidth: 1, borderColor: T.line, borderRadius: 18, padding: 17, marginBottom: 12, alignItems: "center" },
